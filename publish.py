...
def make():
    ...
    roald.set_uri_format('http://data.ub.uio.no/tekord/c{id}')
    roald.save('tekord.json')

    marc21options = {
       'vocabulary_code': 'tekord',
       'created_by': 'NoOU'
    }
    roald.export('dist/tekord.marc21.xml', format='marc21', **marc21options)
    roald.export('dist/tekord.ttl', format='rdfskos',
             include=['tekord.scheme.ttl', 'ubo-onto.ttl'],
             mappings_from=['src/mappings.rdf'],
